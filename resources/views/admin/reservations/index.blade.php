...
<div class="container-fluid px-4 py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <form method="GET" action="{{ route('admin.reservations.index') }}" class="d-flex mb-3">
        ...
        <div class="col-xl-4 col-lg-6 col-md-6">
            <div class="card shadow-sm border-0 h-100">
                ...
                <div class="position-relative">
                    ...
                    @endif
                    <span class="position-absolute top-0 end-0 m-2 badge rounded-pill bg-{{ 
            ...
            <div class="card shadow-sm border-0">
                <div class="card-body text-center py-5">
                    ...
                    <a href="#" class="btn btn-primary btn-sm">
                        <i class="fas fa-plus me-1"></i> Create New Reservation
                    </a>
                </div>
            </div>
        </div>
    ...
    <!-- Pagination - Only show if using paginate() in controller -->
