                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-4">
                        <div class="card card-hover">
                            ...
                            <img src="{{ asset('build/assets/images/r1.jpg') }}" class="card-img-top" alt="Luxury Room">
                            <div class="card-body">
                    ...
                    <div class="col-md-4">
                        <div class="card card-hover">
                            <img src="{{ asset('build/assets/images/r2.jpg') }}" class="card-img-top" alt="Luxury Room">
                            <div class="card-body">
                                <h5 class="card-title">Luxury Room</h5>
                    ...
                    <div class="col-md-4">
                        <div class="card card-hover">
                            ...
                            <img src="{{ asset('build/assets/images/r3.jpg') }}" class="card-img-top" alt="Deluxe Room">
                            <div class="card-body">
                    ...
                    <div class="col-md-4">
                        <div class="card card-hover">
                            <img src="{{ asset('build/assets/images/r4.jpg') }}" class="card-img-top" alt="Standard Room">
                            <div class="card-body">
                    ...
                    <div class="col-md-4">
                        <div class="card card-hover">
                            <img src="{{ asset('build/assets/images/r5.jpg') }}" class="card-img-top" alt="Standard Room">
                            <div class="card-body">
                    ...
                    <div class="col-md-4">
                        <div class="card card-hover">
                            <img src="{{ asset('build/assets/images/r6.jpg') }}" class="card-img-top" alt="Standard Room">
                            <div class="card-body">
                                <h5 class="card-title">Standard Room</h5>
                                <p class="card-text">10000 / Per Night</p>
                            </div>
