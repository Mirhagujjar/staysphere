...
<div class="container section-container">
    <div class="row align-items-center">
        ...
        <div class="col-lg-5 col-md-6 position-relative text-center ">
            <img src="{{ asset('build/assets/images/washroom.jpg') }}" alt="Main Image" class="img-fluid rounded-img main-img">
        ...
        <div class="row justify-content-between">
            ...
            <div class="col-lg-4">
                <div class="title mb-4">
                    <small class="text-muted">StaySphere FAQ</small>
                    <h3 class="mb-3">Frequently Asked Questions</h3>
                    <p>Can’t find your question in the list? Let us know your queries, and we’ll get back to you!</p>
                    <a href="{{ route('contact.index') }}" class="btn btn-primary mt-3">Contact Us</a>
                </div>
            </div>
                ...
                <div class="accordion" id="faqAccordion">
                    ...
                    <div class="card mb-3">
                        <div class="card-header" id="headingOne">
                            <h5 class="mb-0">
                                <button class="btn btn-link text-dark collapsed" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                        ...
                        <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-bs-parent="#faqAccordion">
                            <div class="card-body">
                                We offer a 24-hour cancellation policy. Any cancellations made within 24 hours will be charged a cancellation fee.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card mb-3">
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-bs-parent="#faqAccordion">
                            <div class="card-body">
                                Payments can be made online using your credit card or through bank transfers. We also accept payment upon check-in.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card mb-3">
                        ...
                        <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-bs-parent="#faqAccordion">
                            <div class="card-body">
                                Check-in starts at 2:00 PM, and check-out is until 11:00 AM. Early check-in or late check-out can be arranged upon request.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card mb-3">
                        <div class="card-header" id="headingFour">
                            <h5 class="mb-0">
                                <button class="btn btn-link text-dark collapsed" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                                    <i class="bi bi-plus-circle me-2"></i> Is your hotel accessible for disabled guests?
                                </button>
                            </h5>
                        </div>
                        <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-bs-parent="#faqAccordion">
                            <div class="card-body">
                                Yes, our hotel is fully accessible for disabled guests, with wheelchair ramps, elevators, and specially designed rooms.
                            </div>
                        </div>
                    </div>
                </div>
