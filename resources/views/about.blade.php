...
<div class="container mt-4">
    ...
    <blockquote class="blockquote text-center">
        <p class="mb-0">"Stay Sphere is the best hotel I've ever stayed at! The staff is incredibly friendly, and the amenities are top-notch."</p>
        <footer class="blockquote-footer">Jane Doe</footer>
    </blockquote>

    <h3 class="text-center mt-4">Join Us</h3>
    <p class="text-center">We invite you to experience the warmth and hospitality of Stay Sphere. <a href="{{ route('hotel.create') }}" class="btn btn-primary">Book your stay today!</a></p>
</div>
</div>
@endsection
