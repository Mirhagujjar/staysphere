...
<div class="container my-5">
    ...
    <section class="gallery-section">
        ...
        <div class="gallery-grid">
            ...
            <div class="gallery-item"><img src="{{ asset('build/assets/images/events/exhibition.jpg') }}" alt="event5"></div>
            <div class="gallery-item"><img src="{{ asset('build/assets/images/events/smallevents.jpg') }}" alt="event6"></div>
        </div>
    </section>
