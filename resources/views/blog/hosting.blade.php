...
.hero-section {
    position: relative;
    background: url('{{ asset('build/assets/images/blog/7.jpg') }}') no-repeat center center;
...
<section class="gallery-section">
    ...
    <div class="gallery-grid">
        <div class="gallery-item"><img src="{{ asset('build/assets/images/blog/r6.jpg') }}" alt="event 1"></div>
        <div class="gallery-item"><img src="{{ asset('build/assets/images/blog/r7.jpg') }}" alt="event 2"></div>
        <div class="gallery-item"><img src="{{ asset('build/assets/images/blog/r3.jpg') }}" alt="event 3"></div>
        <div class="gallery-item"><img src="{{ asset('build/assets/images/events/bayan.jpg') }}" alt="event 4"></div>
        <div class="gallery-item"><img src="{{ asset('build/assets/images/events/exhibition.jpg') }}" alt="event 5"></div>
        <div class="gallery-item"><img src="{{ asset('build/assets/images/events/smallevents.jpg') }}" alt="event 6"></div>
    </div>
</section>
    <!-- Comments Section -->
