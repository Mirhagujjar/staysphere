...
.hero-section {
    position: relative;
    background: url('{{ asset('build/assets/images/blog/M0.jpg') }}') no-repeat center center;
...
<section class="gallery-section">
    ...
    <div class="gallery-grid">
        <div class="gallery-item"><img src="{{ asset('build/assets/images/blog/M1.png') }}" alt="menu 1"></div>
        <div class="gallery-item"><img src="{{ asset('build/assets/images/blog/M2.jpg') }}" alt="menu 2"></div>
        <div class="gallery-item"><img src="{{ asset('build/assets/images/blog/M3.jpg') }}" alt="menu 3"></div>
        <div class="gallery-item"><img src="{{ asset('build/assets/images/blog/M4.jpg') }}" alt="menu 4"></div>
        <div class="gallery-item"><img src="{{ asset('build/assets/images/blog/M5.jpg') }}" alt="menu 5"></div>
