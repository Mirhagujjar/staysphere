...
<style>
    ...
    .hero-section {
        position: relative;
        background: url('{{ asset('build/assets/images/blog/5.jpg') }}') no-repeat center center;
...
<div class="container my-5">
    ...
    <section class="gallery-section">
        ...
        <div class="gallery-grid">
            <div class="gallery-item"><img src="{{ asset('build/assets/images/rooms/room1.jpg') }}" alt="room 1"></div>
            <div class="gallery-item"><img src="{{ asset('build/assets/images/rooms/room2.jpg') }}" alt="room 2"></div>
            <div class="gallery-item"><img src="{{ asset('build/assets/images/rooms/room3.jpg') }}" alt="room 3"></div>
            <div class="gallery-item"><img src="{{ asset('build/assets/images/rooms/room4.jpg') }}" alt="room 4"></div>
            <div class="gallery-item"><img src="{{ asset('build/assets/images/rooms/room5.jpg') }}" alt="room 5"></div>
            <div class="gallery-item"><img src="{{ asset('build/assets/images/rooms/room6.jpg') }}" alt="room 6"></div>
        </div>
    </section>
